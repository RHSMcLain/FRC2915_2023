...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final int kFrontLeftTurningEncoderPorts = 7;
    ...
    public static final int kFrontRightDriveEncoderPorts = 4;
    public static final int kRearRightDriveEncoderPorts = 2;
